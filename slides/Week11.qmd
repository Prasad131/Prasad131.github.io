...
$$
\tau_{ij}=-\bar{p_{eff}}\delta_{ij}+\mu_{eff}\left( \frac{ \partial \bar{u_{i}} }{ \partial x_{j} } +\frac{ \partial \bar{u_{j}} }{ \partial x_{i} }  \right)
$$

where $\bar{p_{eff}}=\bar{p}+\frac{2}{3}\rho k$ and $\mu_{eff}=\mu+\mu_{t}$ 
